...
func TestConfigBulider(t *testing.T) {
	...
	out, err := builder.Build(&Answer{
		RepositoryURL:       "https://github.com/newrelic-forks/git-chglog/git-chglog/",
		Style:               styleNone,
	...
	assert.Contains(out, "  repository_url: https://github.com/newrelic-forks/git-chglog/git-chglog")
